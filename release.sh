...
print_message $BLUE "   https://github.com/Grazulex/laravel-statecraft/actions/workflows/release.yml"
...
print_message $YELLOW "   - GitHub: https://github.com/Grazulex/laravel-statecraft/releases"
print_message $YELLOW "   - Packagist: https://packagist.org/packages/grazulex/laravel-statecraft"
